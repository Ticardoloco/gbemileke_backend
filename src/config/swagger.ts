...
// CDN assets prevent blank screens on Vercel serverless execution
...
const options: swaggerJSDoc.Options = {
  ...
  // Reads compiled .js files in production and .ts files during dev
  apis: [
...
export function setupSwagger(app: Express): void {
  ...
  console.log("🏥 Gbemileke Hospital Docs configured for /docs");
}